...
<body>
			...
			<div class="container-fluid">
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> Farha Islam
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?php echo e(URL::to('/dashboard')); ?>"><i></i><span class="hidden-tablet"> Dashboard</span></a></li>	
						<li><a href="<?php echo e(URL::to('/all-category')); ?>"><i></i><span class="hidden-tablet"> All Category</span></a></li>
						<li><a href="<?php echo e(URL::to('/add-category')); ?>"><i></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="<?php echo e(URL::to('/all-manufacture')); ?>"><i></i><span class="hidden-tablet"> All Manufacture</span></a></li>
						<li><a href="<?php echo e(URL::to('/add-manufacture')); ?>"><i></i><span class="hidden-tablet">Add Manufacture</span></a></li>
						
						<li>
							<a class="dropmenu" href="#"><i></i><span class="hidden-tablet"> Products</span><span class="label label-important"> New </span></a>
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/all-product')); ?>"><i></i><span class="hidden-tablet"> All Products</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/add-product')); ?>"><i></i><span class="hidden-tablet"> Add Product</span></a></li>
								
							</ul>	
						</li>
						<li>
							<a class="dropmenu" href="#"><i></i><span class="hidden-tablet"> Slider </span></a>
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/all-slider')); ?>"><i></i><span class="hidden-tablet"> All Slider</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/add-slider')); ?>"><i></i><span class="hidden-tablet"> Add Slider</span></a></li>
								
							</ul>	
						</li>
						
						<li><a href="chart.html"><i></i><span class="hidden-tablet"> Social Link</span></a></li>
						<li><a href="typography.html"><i></i><span class="hidden-tablet"> Shop Name</span></a></li>
						<li><a href="gallery.html"><i></i><span class="hidden-tablet"> Delivery Man</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy;  <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes">creativeLabs</a></span>

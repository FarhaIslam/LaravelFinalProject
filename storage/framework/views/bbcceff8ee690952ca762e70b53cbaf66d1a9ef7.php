                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                              ...
                              <li><a href="<?php echo e(URL::to('/login-check')); ?>"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                 ...
                                 <?php } ?>
                                <li><a href="<?php echo e(URL::to('/cart-show')); ?>"><i class="fa fa-shopping-cart"></i> Cart</a></li>

                              
                             <?php if($customer_id != NULL){ ?>

                               <li><a href="<?php echo e(URL::to('/customer-logout')); ?>"><i class="fa fa-lock"></i> Logout</a></li>
                                <?php } else{ ?>
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                              ...
                              <li><a href="<?php echo e(URL::to('/login-check')); ?>"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                 ...
                                 <?php } ?>
                                        <li><a href="<?php echo e(URL::to('/cart-show')); ?>">Cart</a></li> 
                            ...
                            <div class="brands-name">
                                ...
                                <?php
                                  ...
                                  foreach( $all_published_manufacture as $v_manufacture){?>
                                    <li><a href="<?php echo e(URL::to('/product_by_manufacture/'.$v_manufacture->manufacture_id)); ?>"> <span class="pull-right"></span><?php echo e($v_manufacture->manufacture_name); ?></a></li>
                                       <?php } ?>
                                </ul>
                            </div>
                        </div><!--/brands_products-->
